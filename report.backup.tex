...
\begin{table}[!ht]
    ...
    \hline
        \textbf{Train Monet dataset Augmentations} & \textbf{Train Photo dataset augmentations} & \textbf{Monet Gen loss} & \textbf{Photo Gen loss} & \textbf{Monet Disc loss} & \textbf{Photo Disc loss} & \textbf{Kaggle score} \\ \hline
